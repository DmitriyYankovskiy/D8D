...
let dbClient = { 
    getObject: (tableName, key, value, columns) => {
    ...
    createTable: (tableName, typesOfColumns) => {
    ...
    deleteObject: (tableName, key, value = "") => {
    ...
    setObject: (tableName, key, value, columns) => {
